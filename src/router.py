...
from handlers import Handler, ErrorHandler, StaticHandler, RedirectHandler
...
def _route_get(path: str, query: str):
...
def _route_post(path: str, content_type: str, content: bytes):
    if path == '/add_order':
